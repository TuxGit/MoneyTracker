...
import ru.tux.moneytracker.api.BalanceResult;
    ...
    private void updateData() {
        ...
        call.enqueue(new Callback<BalanceResult>() {
            ...
            public void onResponse(Call<BalanceResult> call, Response<BalanceResult> response) {
                ...
                total.setText(getString(R.string.price_format, result.income - result.expense));
                expense.setText(getString(R.string.price_format, result.expense));
                income.setText(getString(R.string.price_format, result.income));
